...
def wins_t(game_list):
    def loop(lst, wins):
        if lst != []:
            you, com = lst[0]
            if eval(you, com) == 1:
                return loop(lst[1:], wins + 1)
            else:
                return loop(lst[1:], wins)
        else:
            return wins
...
def wins_w(game_list):
    ...
    while game_list != []:
        you, com = game_list[0]
        if eval(you, com) == 1:
            game_list, wins = game_list[1:], wins + 1
        else:
